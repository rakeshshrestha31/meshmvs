...
if __name__ == '__main__':
    data_root = '/datasets/scannet/scans'
    scene = 'scene0008_00'
    print('{}/{}/color'.format(data_root, scene))
    sensor_data = SensorData('{0}/{1}/{1}.sens'.format(data_root, scene))
    sensor_data.export_color_images('{}/{}/color'.format(data_root, scene))
    sensor_data.export_depth_images('{}/{}/depth'.format(data_root, scene))
    sensor_data.export_poses('{}/{}/poses'.format(data_root, scene))
    sensor_data.export_intrinsics('{}/{}/intrinsics'.format(data_root, scene))
