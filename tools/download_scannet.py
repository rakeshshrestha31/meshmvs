...
if __name__ == '__main__':
    # release_file = BASE_URL + RELEASE + ".txt"
    # release_scans = get_release_scans(release_file)
    release_scans = ['scene0008_00']
    print(release_scans)
    out_dir_base = '/datasets/scannet'
    out_dir_scans = os.path.join(out_dir_base, 'scans')
    out_dir_test_scans = os.path.join(out_dir_base, 'scans_test')
    ...
    download_release(release_scans, out_dir_scans, file_types, use_v1_sens=True)
    download_label_map(out_dir_test_scans)
