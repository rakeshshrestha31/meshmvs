...
\rakesh{\figref{initial_vox} added}
\begin{figure}[th!]
    \begin{center}
...
\rakesh{\figref{gcn_stages} and~\tableref{gcn_stages} added}
...
\rakesh{To obtain the depth image of each RGB image, we iteratively regard each view as the reference and apply the standard MVSNet~\cite{yao2018mvsnet}. -> this is not exactly right. Doing this would be inefficient, feature volume is extracted only once and are shared for depth regression of each view}
