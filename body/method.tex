...
along with surface normal loss between vertex normal~\cite{wang2018pixel2mesh}
...
\paragraph{Depth loss}\vspace{-4mm}
...
\paragraph{Voxel loss}\vspace{-4mm}
Binary cross-entropy loss between the predicted voxel occupancy probabilities and the ground truth occupancy is used as voxel loss to supervise the voxel predictions to constrain the coarse initial shapes~\cite{gkioxari2019meshrcnn}
...
\paragraph{Final loss}\vspace{-4mm}
We use the weighted sum of the individual losses discussed above as the final loss to train our model in an end-to-end fashion.
