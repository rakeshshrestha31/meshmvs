...
We analyze the accuracy of meshes at different GCN stages in~\tableref{gcn_stages}. The results validate that our method produces the meshes in a coarse-to-fine manner and multiple GCN refinements improve the mesh quality.
